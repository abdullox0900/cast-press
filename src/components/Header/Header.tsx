                    ...
                    <nav className='hidden md:block'>
                        <ul className='flex items-center gap-[39px]'>
                            <li className='flex items-center gap-2'>
                                <Link href='/' className='text-[16px] font-semibold text-[#222222]'>Episodes</Link>
                                <Image className='mt-[5px]' src={ArrowIcon} alt='icon' width={10} height={6} />
                            </li>
                            <li><Link href='/about' className='text-[16px] font-semibold text-[#222222]'>Blog</Link></li>
                            <li><Link href='/contact' className='text-[16px] font-semibold text-[#222222]'>Contact</Link></li>
                            <li><Link href='/contact' className='text-[16px] font-semibold text-[#222222]'>Donate</Link></li>
                            <li>
